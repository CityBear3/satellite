...
var DeviceWhere = struct {
	...
	Description: whereHelpernull_String{field: "`device`.`description`"},
...
var (
	deviceAllColumns            = []string{"id", "name", "description", "secret", "client_id", "is_deleted"}
	deviceColumnsWithoutDefault = []string{"id", "name", "description", "secret", "client_id"}
