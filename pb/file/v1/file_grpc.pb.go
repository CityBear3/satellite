...
func (c *fileServiceClient) UploadFile(ctx context.Context, opts ...grpc.CallOption) (FileService_UploadFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &FileService_ServiceDesc.Streams[0], "/satellite.file.v1.FileService/UploadFile", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *fileServiceUploadFileClient) CloseAndRecv() (*emptypb.Empty, error) {
...
func (c *fileServiceClient) GetFile(ctx context.Context, in *GetFileRequest, opts ...grpc.CallOption) (FileService_GetFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &FileService_ServiceDesc.Streams[1], "/satellite.file.v1.FileService/GetFile", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *fileServiceUploadFileServer) SendAndClose(m *emptypb.Empty) error {
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "satellite.file.v1.FileService",
