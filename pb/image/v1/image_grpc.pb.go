...
type ImageServiceClient interface {
	...
	GetImage(ctx context.Context, in *GetImageRequest, opts ...grpc.CallOption) (ImageService_GetImageClient, error)
}
...
func (c *imageServiceClient) UploadImage(ctx context.Context, opts ...grpc.CallOption) (ImageService_UploadImageClient, error) {
	stream, err := c.cc.NewStream(ctx, &ImageService_ServiceDesc.Streams[0], "/satellite.image.v1.ImageService/UploadImage", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *imageServiceClient) GetImage(ctx context.Context, in *GetImageRequest, opts ...grpc.CallOption) (ImageService_GetImageClient, error) {
	stream, err := c.cc.NewStream(ctx, &ImageService_ServiceDesc.Streams[1], "/satellite.image.v1.ImageService/GetImage", opts...)
	if err != nil {
		return nil, err
	}
...
type ImageServiceServer interface {
	...
	GetImage(*GetImageRequest, ImageService_GetImageServer) error
...
func (UnimplementedImageServiceServer) GetImage(*GetImageRequest, ImageService_GetImageServer) error {
...
var ImageService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "satellite.image.v1.ImageService",
